...
class Suggestions extends React.Component{
    ...
    submitHandler=(event)=>{
       ...
       if(data.nameinput!=='' && data.emailinput!=='' && data.phoneinput!=='' && data.suggestioninput!=='' && data.nameinput!==''){


            axios.post('https://covid-kanvas.firebaseio.com/covid-kanvas.json',data)
                .then(response=>{
                    ...
                    this.setState({
                        ...
                        phoneChange:'',
                        suggestionChange:'',
                        result:<p className='success'>Your Suggestion Has Been Submitted Successfully</p>,
                        loading:false
                    })
    ...
    render(){
        let form= (<div className='suggestionForm'>
       ...
       <p> Your Name : </p> 
             <input type='text' placeholder='Name' className='InputElement' onChange={this.nameChangeHandler}/>
       <p>Your E-Mail ID :</p>
            <input type='tex' placeholder='E-Mail' className='InputElement' onChange={this.mailChangeHandler}/>
       <p>Your Contact No. :</p>
            <input type='text' placeholder='Contact No.' className='InputElement' onChange={this.phoneChangeHandler}/>
       <p>Your Suggestion For Fight Against Coronavirus</p>
            <textarea placeholder='Suggestion' className='InputElement' onChange={this.suggestionChangeHandler}/>
            <Button className="SubmitButton" clicked={this.submitHandler}>SUBMIT</Button>
           {this.state.result}
        ...
        if(this.state.loading){
                form=<div className='suggestionForm' style={{justifyContent:'center',textAlign:"center",paddingLeft:'15%'}}><Spinner/></div>;
            }
